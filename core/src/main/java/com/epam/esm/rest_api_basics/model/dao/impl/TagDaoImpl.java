...
import com.epam.esm.rest_api_basics.model.dao.util.TagRowMapper;
...
public class TagDaoImpl implements TagDao {
     ...
     */
    @Override
    public Tag getTagByName(String name) throws NoDataFoundException {
        try {
     ...
     */
    @Override
    public boolean deleteTagFromCertificates(Long id) {
